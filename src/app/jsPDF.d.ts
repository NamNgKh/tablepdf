export declare class jsPDF {
    ...
    autoTable(columns: string[] | AutoTableColumn[], data: any[], options: AutoTableOptions);
    autoTableText(text: string, x: number, y: number, styles: AutoTableStyles);
}
...
export interface AutoTableOptions {
    ...
    pageBreak?: string;
    createdHeaderCell?: (cell: AutoTableCell, data: AutoTableData) => {};
    createdCell?: (cell: AutoTableCell, data: AutoTableData) => void;
    drawHeaderRow?: (row: AutoTableRow, data: AutoTableData) => void;
    drawRow?: (row: AutoTableRow, data: AutoTableData) => void;
    drawHeaderCell?: (cell: AutoTableCell, data: AutoTableData) => void;
    drawCell?: (cell: AutoTableCell, data: AutoTableData) => void;
    addPageContent?: (data: AutoTableData) => void;
}
